...
function simpan() {
    ...
    if (nama === '') {
        ...
        if (role === 'R00004') {
            ...
            // Pengecekan jumlah subtopik di sini
            var subtopik = <?= $jml_subtopik; ?>;

            if (subtopik >= 1) {

                alert("Anda hanya bisa membuat 1 subtopik, Hubungi Admin untuk info selengkapnya.");
...
document.querySelector('.side-topik').classList.add('active');
</script>
...
<section class="section">
    <div class="row-btn">
        ...
        <ol class="breadcrumb bg-white d-flex align-items-end">
            ...
            <h5 class="me-1 mb-0">Detil Subtopik</h5><small>Maintenance data subtopik</small>
        </ol>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-xs-12">
                <div class="card-body">
                    ...
                    <input type="hidden" value="<?= $jml_subtopik; ?>">
