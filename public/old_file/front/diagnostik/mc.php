                                            ...
                                            <div style="text-align: justify; text-justify: inter-word;"
                                                ...
                                                <div style="text-align: justify; text-justify: inter-word;">
                                                    ...
                                                    <h6 style="color: blue;">Click to start audio! (One-time play)
                                                        <button id="btnaudio_<?php echo $row->idsoal; ?>"
                                                            name="btnaudio_<?php echo $row->idsoal; ?>"
                                                            class="btn-lg btn-warning"
                                                            onclick="playOnce('<?php echo $row->idsoal; ?>')">Play</button>
                                                    </h6>
                                                    <audio id="myAudio<?php echo $row->idsoal; ?>"
                                                        src="<?php echo $def_audio; ?>"></audio>
