        ...
        <main style="font-size: 12px;">
            ...
            <table style="border-collapse: collapse; border: 1px solid #b7bec5; margin-top: 10px; margin-bottom: 5px; width: 100%;">
                ...
                <tr>
                    ...
                    <td style="text-align: justify; border: 1px solid #b7bec5; padding: 5px; width: 100px;"><?php echo $row->jawab; ?></td>
                    <?php if($row->hasil == 1) {?>
                    <td style="text-align: center; border: 1px solid #b7bec5; padding: 5px; width: 130px; color: green"><b>Right</b></td>
                    <?php }else{ ?>
                    <td style="text-align: center; border: 1px solid #b7bec5; padding: 5px; width: 130px; color: red"><b>Wrong</b></td>
                    <?php } ?>
                </tr>
                <?php } ?>
            </table>
