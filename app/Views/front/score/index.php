                            ...
                            <div class="card-header">
                                <div class="covid-wrap">
                                    ...
                                    <div class="covid-test-wrap test-step thankyou-sec active">
                                        ...
                                        <?php echo $penutup; ?>
                                        <a href="#" onclick="linkwa(<?php echo substr_replace($wa ,'62',0,1) ?>,'<?php echo $text; ?>')" class="button-reloads" style="margin-bottom: 20px;">Call Us<i class="lab la-whatsapp"></i></a>
                                        <?php if($score < 100){ ?>
                                        <a href="<?php echo base_url().'/test/start/'.$idsub; ?>" class="buttons-reloads" style="margin-bottom: 20px;">Try Again</a>
                                        <?php } ?>
                                        <a href="<?php echo base_url(); ?>/" class="button-reload">Back to main home</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
