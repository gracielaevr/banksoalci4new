                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-sm-12">
                                                        <div class="form-group">
                                                            <input type="radio" name="pilihan<?php echo $i;?>" class="form-control" id="T<?php echo $i;?>" value="True" required>
                                                            <label for="T<?php echo $i;?>">True</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-sm-12">
                                                        <div class="form-group">
                                                            <input type="radio" name="pilihan<?php echo $i;?>" class="form-control" id="F<?php echo $i;?>" value="False" required>
...
<script type="text/javascript">
    function simpan() {
        ...
        }else{ document.getElementById("errorsoal6").setAttribute("hidden", "hidden"); tot += 1; }
        if (p7 === undefined) {
            document.getElementById("errorsoal7").removeAttribute("hidden");
        }else{ document.getElementById("errorsoal7").setAttribute("hidden", "hidden"); tot += 1; }
        if (p8 === undefined) {
            document.getElementById("errorsoal8").removeAttribute("hidden");
        }else{ document.getElementById("errorsoal8").setAttribute("hidden", "hidden"); tot += 1; }
        if (p9 === undefined) {
            document.getElementById("errorsoal9").removeAttribute("hidden");
        }else{ document.getElementById("errorsoal9").setAttribute("hidden", "hidden"); tot += 1; }
        if (p10 === undefined) {
            document.getElementById("errorsoal10").removeAttribute("hidden");
        }else{ document.getElementById("errorsoal10").setAttribute("hidden", "hidden"); tot += 1; }
