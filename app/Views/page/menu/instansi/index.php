...
function save() {
    ...
    var jml_siswa = document.getElementById('jml_siswa').value;
    ...
    if (nama_instansi === '') {
        ...
        form_data.append('jml_siswa', jml_siswa);
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        <label for="jml_siswa" class="col-sm-5 control-label">Jumlah Siswa</label>
                        <div class="col-sm-12">
                            <input type="number" class="form-control" id="jml_siswa" name="jml_siswa"
                                placeholder="Masukkan jumlah siswa disini" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label for="kontak" class="col-sm-5 control-label">Contact Person</label>
                        <div class="col-sm-12">
