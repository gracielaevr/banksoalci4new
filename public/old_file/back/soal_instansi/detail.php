    ...
    // }
        ...
        if (kode === '') {
            ...
            if (role === 'R00004') {
                var soal = <?= $jml_soal; ?>;
                if (soal >= 5) {
                    alert("Anda hanya bisa membuat 5 soal, Silahkan Hubungi admin untuk informasi selengkapnya .");
                    reload_page();
                } else {
...
document.querySelector('.side-soalinstansi').classList.add('active');
</script>
                ...
                <div class="box">
                    <div class="box-body">
                        <div class="form-horizontal">
                            ...
                            <input type="hidden" value="<?= $jml_soal; ?>">
                            <input type="hidden" name="idsubtopik" id="idsub" value="<?php echo $head->idsubtopik; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <button id="btnCancel" type="button" class="btn btn-sm btn-danger"
                                        onclick="reload_page();">Batal</button>
                                </div>
                                <div class="col-sm-1">
            ...
            <div class="col-lg-12 col-xs-12">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Topik</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" value="<?php echo $head->namatopik; ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Subtopik</label>
                            ...
                            <select class="form-control select2" id="subtopik" name="subtopik"
                                ...
                                <php foreach ($subtopik->getResult() as $row) { ?>
                                    <option value="<php echo $row->idsubtopik; ?>">
                                        <php echo $row->sub . ' == (Topik : ' . $row->top . ')'; ?>
                                    </option>
                                    <php } ?>
                            </select>
                        </div>
