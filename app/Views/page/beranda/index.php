            ...
            <div class="row justify-content-center">
                ...
                <div class=" row justify-content-center align-items-center">
                    ...
                    <div class="col-lg-6 video-left" data-aos="fade-left">
                        ...
                        <p>Improve your English skills by accessing carefully curated questions designed to help you
                            achieve the best results. With expert guidance, you'll receive tailored feedback during live
                            discussion sessions.</p>
                        <ul>
                            <li>Access high-quality English practice questions</li>
                            <li>25-minute interactive discussion sessions</li>
                            <li>Local and international teachers ready to assist
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row justify-content-center align-items-center pt-5">
                    <div class="col-lg-6 video-left" data-aos="fade-right">
                        ...
                        <p>As an English teacher, you can contribute by adding practice questions and guiding students
                            through discussion sessions. Use this platform to share your knowledge and help students
                            improve their English skills.</p>
                        <ul>
                            <li>Add English practice questions</li>
                            <li>Provide students with in-depth question discussions</li>
                            <li>Build your teaching portfolio on a global platform </li>
                        </ul>
                        <h3 style="color: red;">COMMING SOON</h2>
                    </div>
                    <div class="col-lg-6 video-right justify-content-center align-items-center d-flex"
                        data-aos="fade-left">
                        <div class="overlay overlay-bg"></div>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <div class="cta-buttons">
                        <a class="cta-btn mb-3" href="trial">Try as Student</a>
                        <a class="cta-btn" href="logininstansi">Try as Teacher (coming soon)</a>
                    </div>
                </div>
    ...
    <section id="team" class="team menu-area">
        <div class="container d-flex justify-content-center" data-aos="fade-up">
            ...
            <div class="row justify-content-center">
                ...
                <button id="btnMore" class="btn2 btn-info btn-md" style="margin-top: 20px" onclick="more();">Read
                    More . . .</button>
            </div>
        </div>
