                ...
                <section class="section">
                    <div class="section-header">
                        ...
                        <div class="section-header-breadcrumb buttons">
                            <a href="homesiswa" class="btn btn-icon icon-left btn-primary"><i class="far fa-edit"></i>
                                Back to Main Home</a>
                        </div>
                    </div>
                    ...
                    <div class="section-body">
                        <div class="card pl-5">
                            <div class="card-header">
                                <h3 class='font-26'>Changing the Verb (Change Verb 1 into Verb-ing) Excercise</h3>
                            </div>
                            <div class="card-body">
                                <p class='font-20 mt-20'>What is the capital of France?</p>
                                <form>
                                    <input type="radio" name="answer" id="paris" value="paris">
                                    <label for="paris">Paris</label><br>

                                    <input type="radio" name="answer" id="london" value="london">
                                    <label for="london">London</label><br>

                                    <input type="radio" name="answer" id="berlin" value="berlin">
                                    <label for="berlin">Berlin</label><br>

                                    <input type="radio" name="answer" id="madrid" value="madrid">
                            ...
                            <div class="card-footer bg-whitesmoke">
                                <div class="buttons">
                                    <a href="#" class="btn btn-lg btn-primary middle"><b>Submit</b></a>
                                </div>
                            </div>
                        </div>
                    </div>
