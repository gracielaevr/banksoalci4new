                    ...
                    <div class="ugf-donation">
                        <div class="ugf-form-card">
                            <div class="card-header">
                                <h1 style="margin-bottom: 10px; color: black;"><?php echo $bidang; ?> Diagnostic Test
                                </h1>
                                    ...
                                    <div class="covid-test-wrap test-step active">
                                        ...
                                        <div class="step-block">
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <span hidden="hidden" class="error er" id="errormail">*
                                                            Required</span>
                                                        <span hidden="hidden" class="error er" id="errormail2">* Invalid
                                                            Email Address</span>
                                                        <span hidden="hidden" class="error er" id="errormail3">* This
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="alamat"
                                                            name="alamat" placeholder="Your Domicile">
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="instansi"
                                                            name="instansi" placeholder="Your Company Name">
                                            ...
                                            <button class="button" id="btnSave" name="btnSave"
                                                style="background: #456bab;" onclick="simpan();">I'm ready for the
                                                test!</button>
                                        </div>
                                    </div>
                                </div>
