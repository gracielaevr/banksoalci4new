                    ...
                    <div class="box-body">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="benar" name="benar" placeholder="0" min="0">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Score</label>
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="skor" name="skor" placeholder="0" min="0">
                                </div>
                            </div>
                            <div class="form-group">
