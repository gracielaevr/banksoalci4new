...
">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown d-flex align-items-center">
                    ...
                    <ul class="dropdown-menu sidenav-murid  dropdown-menu-end  px-2 py-2 me-sm-n2"
                ...
                <div class="col-lg-5 col-md-7 col-sm-9 shadow-leap p-5" style="border-radius:12px">
                    <form>
                        <div class="covid-test-wrap test-step thankyou-sec active">
                            ...
                            <?php if ($free): ?>
                                <a href="<?php echo base_url() . 'Subscribe' ?>" class="btn-score-wa "
                                    style="margin-bottom: 20px;">Question Discussion</a>
                                <!-- <php if ($score < 100) { ?> -->
                                <a href="<?php echo base_url() . 'subtopic1/start/' . $idsub; ?>" class="btn-score-again"
