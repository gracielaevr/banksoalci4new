                ...
                <div class="ugf-dontation-wrap">
                    ...
                    <div class="ugf-form-card">
                            <div class="card-header">
                                <h1 style="margin-bottom: 10px; color: black;"><?php echo $bidang; ?> Diagnostik Test</h1>
                                ...
                                <div class="form">
                                    ...
                                    <hr>
                                    <p style="text-align: center;">Isi formulir ini sebelum Anda mulai!</p>
                                    <div class="step-block">
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Lengkap">
                                                <span hidden="hidden" class="error er" id="errorname">* Wajib</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <span hidden="hidden" class="error er" id="errormail">* Wajib</span>
                                                <span hidden="hidden" class="error er" id="errormail2">* Alamat Email Tidak Valid</span>
                                                <span hidden="hidden" class="error er" id="errormail3">* Email ini sudah terdaftar</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                <input type="text" class="form-control" id="tlp" name="tlp"  placeholder="Nomor Telp / Hp" onkeypress="return hanyaAngka(event,false);">  
                                                <span hidden="hidden" class="error er" id="errorphone">* Wajib</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <span hidden="hidden" class="error er" id="erroralamat">* Wajib</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                <input type="text" class="form-control" id="instansi" name="instansi"  placeholder="Nama Perusahaan">  
                                                <span hidden="hidden" class="error er" id="errorinstansi">* Wajib</span>
                                                </div>
                                            </div>
                                        </div>
                                        
                                        <button class="button" id="btnSave" name="btnSave" style="background: #456bab;" onclick="simpan();">Mulai Test!</button>
                                        </div>
                                      </div>
                                    </div>
                                </div>
