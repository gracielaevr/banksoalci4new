                    ...
                    <div class="section-body mt-4">
                        <div class="card shadow-leap p-3">
                            ...
                            <div class="card-header d-flex justify-content-between mb-3 topic-column-sm">
                                ...
                                <input type="hidden" id="idsubtopik" name="idsubtopik" value="<?= $topik; ?>">
                            ...
                            <div class="card-body">
                                ...
                                <h3><?php echo str_replace('p>', 'h6>', $row->soal); ?></h3>
                            ...
                            <button id="btnSimpan" class="btn btn-primary-leap w-100 pt-3"
