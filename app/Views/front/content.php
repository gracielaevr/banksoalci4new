                    ...
                    <div class="ugf-donation">
                        <div class="logo">
                            <a href="<?php echo base_url(); ?>"><img
                                    ...
                                    alt="logo" width="150px" height="70px"></a>
                        </div>
                        <h1>FREE ENGLISH TEST</h1>
                        <p>Having trouble finding English practice questions to help you study for school exams? Are you
                            getting ready to compete in an English event or Olympiad? Or perhaps you simply want to
                            measure how well your English is? Try the Leap English test questions now! <b>It's Free!</b>
                        </p>
                        <div class="form">
                            ...
                            <button id="btnMore" class="btn btn-info btn-sm" style="margin-top: 20px; color: blue;"
            ...
            <div class="col-lg-5">
                <div class="widget">
                    <div class="social-link">
                        <ul>
                            <<<<<<< HEAD <li><a target="_blank" href="/banksoal/public/loginsiswa">Student Sign in</a>
                                </li>
                                <li><a target="_blank" href="/banksoal/public/login">Teacher Sign in</a></li>
                                =======
                                <li><a target="_blank" href="http://localhost/banksoal/public/loginsiswa">Test As
                                        Yourself</a></li>
                                <li><a target="_blank" href="http://localhost/banksoal/public/logininstansi">Test As
                                        School</a></li>
                    ...
                    <div class="footer">
                        <p>Copyright &copy; <?php echo date("Y"); ?> <a href="<?php echo base_url(); ?>">Leapverse -
                                Bank Soal</a>. All Rights Reserved</p>
                    </div>
                </div>
            </div>
        </div>
