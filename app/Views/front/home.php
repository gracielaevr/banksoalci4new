    ...
    <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar ml-auto">
            <ul>
                ...
                <li><a class="nav-link   scrollto" href="#team">Question</a></li>
...
<main id="main">
    ...
    <section class="video-sec-area pb-100 pt-40" id="about">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row justify-content-start align-items-center pt-5">
                <div class="col-lg-6 video-left pl-0" style="padding:0 10% 0 0;" data-aos="fade-right">
                    <h6>Data visualization.</h6>
                    <h1>Lorem ipsum dolor sit amet</h1>
                    <p><span>We are here to listen from you deliver exellence</span></p>
                    <p>
                ...
                <div class="col-lg-6 video-right justify-content-center align-items-center d-flex" data-aos="fade-left">
                    <div class="overlay overlay-bg"></div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <div class="cta-buttons">
                        <a class="cta-btn" href="loginsiswa">Test Yourself</a>
    ...
    <section id="team" class="team menu-area">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                <?php
                $count = 0; // Inisialisasi hitungan baris
                foreach ($topik as $key => $value):
                    if ($count < 16): // Hanya tampilkan 16 baris
                ?>
                <div class="col-lg-3">
                    <a href="loginpage">
                ...
                <?php
                        $count++; // Tambahkan hitungan setiap kali iterasi
                    endif;
                endforeach;
                ?>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 footer-contact">
                    <h3>LEAP English & Digital</h3>
                    <p>
                        Jl. Rungkut Asri Tengah VII No.51 <br>
                        Rungkut Kidul, Kec. Rungkut, Surabaya<br>
                        Jawa Timur 60293 <br><br>
                        <strong>Phone:</strong> 0813-3538-1619<br>
                        <strong>Email:</strong> HQ@leapsurabaya.sch.id<br>
                    </p>
                </div>
