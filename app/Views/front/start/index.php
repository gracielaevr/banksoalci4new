                    ...
                    <div class="ugf-donation">
                        <div class="ugf-form-card">
                            <div class="card-header">
                                <h1 style="margin-bottom: 10px; color: black;"><?php echo substr($subtopik, 0, strpos($subtopik, "(")); ?></h1>
                                <h6 style="margin-bottom: 10px; color: black;"><?php echo substr($subtopik, strpos($subtopik, '(')); ?></h6>
                                ...
                                <div class="form">
                                    <button class="btn" style="background: #456bab;" onclick="mulai(<?php echo $tot; ?>);">I'm ready for the test!</button>
                                </div>
                            </div>
                        </div>
                    </div>
