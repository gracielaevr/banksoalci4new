    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-box-body">
                ...
                <p style="font-size: 12px; text-align: center;">Enter Leap Teacher account</p>
                <div class="form-group has-feedback">
                    <input id="email" name="email" type="email" class="form-control" placeholder="Email" autocomplete="off" autofocus>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <button id="btnProses" type="button" class="btn btn-primary btn-block btn-flat" onclick="proses();">Masuk</button>
                    </div>
                </div>
                <!--
                ...
                if(email === ""){
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            }else if(response.status === "ok_sadmin"){
                                window.location.href = "<?php echo base_url(); ?>homesadmin";
                            }else{
