                    ...
                    <div class="form-horizontal">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="tahun" name="tahun"
                                        onkeypress="return hanyaAngka(event, false);" value="<?php echo $tahun; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="pimpinan" class="col-sm-2 control-label">Nama Pimpinan</label>
                                <div class="col-sm-10">
                                    <input class="form-control" id="pimpinan" name="pimpinan" type="text"
                                        value="<?php echo $pimpinan; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" id="kdpos" name="kdpos" type="text"
                                        onkeypress="return hanyaAngka(event, false);" value="<?php echo $kdpos; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="tlp" class="col-sm-2 control-label">Telepon</label>
                                <div class="col-sm-10">
                                    <input class="form-control" id="tlp" name="tlp" type="text"
                                        value="<?php echo $tlp; ?>" onkeypress="return hanyaAngka(event, false);">
                                </div>
                            </div>
                            <div class="form-group">
