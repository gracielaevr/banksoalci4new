...
function hapus(id, nama) {
    if (confirm("Apakah anda yakin menghapus bidang " + nama +
...
<div class="modal fade" id="modal_bidang">
    <div class="modal-dialog">
        <div class="modal-content">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="namabidang" name="namabidang"
                                placeholder="Masukkan nama bidang disini" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="status" class="col-sm-3 control-label">Status</label>
                        <div class="col-sm-9">
                            <select class="form-control" id="statusbidang" name="statusbidang"
                                data-placeholder="Pilih status bidang">
            ...
            <div class="modal-footer">
                <button id="btnSaveBidang" type="button" class="btn btn-sm btn-primary"
...
<div class="modal fade" id="modal_instruksi">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button id="btnSaveInstruksi" type="button" class="btn btn-sm btn-primary"
                    onclick="saveinstruksi();">Simpan</button>
