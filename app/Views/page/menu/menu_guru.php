<div class="collapse navbar-collapse w-auto sidenav-guru" id="sidenav-collapse-main">
    <ul class="navbar-nav">
        <li class="nav-item">
            <a id="dashboard" class="nav-link side-leap side-dashboard" href="<?= base_url() ?>homeguru">
        ...
        <li class="nav-item">
            <a class="nav-link side-leap" href="<?= base_url() ?>jadwalkonsultasi/jadwalguru">
                <i class="fa fa-calendar text-info text-sm"></i>
                <span class="nav-link-text ms-1">Jadwal Guru</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link side-leap side-siswa" href="<?= base_url() ?>jadwalkonsultasi/datasiswa">
