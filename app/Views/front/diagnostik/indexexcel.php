...
function simpan() {
    ...
    if (email != '' && !email.includes("@")) {
        ...
        document.getElementById("errormail2").setAttribute("hidden", "hidden");
        tot += 1;
    }
    if (instansi === '') {
        document.getElementById("errorinstansi").removeAttribute("hidden");
    } else {
        document.getElementById("errorinstansi").setAttribute("hidden", "hidden");
        tot += 1;
    }
    if (alamat === '') {
        document.getElementById("erroralamat").removeAttribute("hidden");
    } else {
        document.getElementById("erroralamat").setAttribute("hidden", "hidden");
        tot += 1;
    }
    ...
    ?
    >
    diagnostictest / checkmail / "+email,
    //     dataType: 'JSON',
    //     type: 'POST',
                    ...
                    <div class="ugf-donation">
                        <div class="ugf-form-card">
                            <div class="card-header">
                                <h1 style="margin-bottom: 10px; color: black;"><?php echo $bidang; ?> Diagnostik Test
                                </h1>
                                    ...
                                    <div class="covid-test-wrap test-step active">
                                        ...
                                        <div class="step-block">
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <span hidden="hidden" class="error er" id="errormail">*
                                                            Wajib</span>
                                                        <span hidden="hidden" class="error er" id="errormail2">* Alamat
                                                            Email Tidak Valid</span>
                                                        <span hidden="hidden" class="error er" id="errormail3">* Email
                                                            ini sudah terdaftar</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="alamat"
                                                            name="alamat" placeholder="Alamat Domisili">
                                                        <span hidden="hidden" class="error er" id="erroralamat">*
                                                            Wajib</span>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="instansi"
                                                            name="instansi" placeholder="Nama Perusahaan">
                                                        <span hidden="hidden" class="error er" id="errorinstansi">*
                                                            Wajib</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <button class="button" id="btnSave" name="btnSave"
                                                style="background: #456bab;" onclick="simpan();">Mulai Test!</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
