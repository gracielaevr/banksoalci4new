    ...
    <div class="container main">
        <div class="row login-card">
            ...
            <div class="col-md-6 right">
                <div class="input-box">
                    <header class="header-regist-instansi text-center">Let’s create your account!</header>
                    <div class="input-field">
                        <input type="name" class="input-instansi " id="name" name="name" required autocomplete="off">
                        <label for="name">Full Name</label>
                    </div>
                    <div class="input-field">
                        <input type="text" class="input-instansi " id="email" name="email" required autocomplete="off">
                        <label for="email">Email Address</label>
                    </div>
                    <div class="input-field">
                        <input type="text" class="input-instansi " id="wa" name="wa" required autocomplete="off">
                        <label for="wa">Phone Number</label>
                    </div>
                    <div class="input-field">
                        <input type="text" class="input-instansi " id="school_name" name="school_name" required
                            autocomplete="off">
                        <label for="school_name">School Name</label>
                    </div>
                    <div class="input-field">
                        <input type="password" class="input-instansi " id="pass" name="pass" required>
                    ...
                    <div class="signin">
                        <span>Already have an account? <a href="logininstansi">Sign
                                in
                                here.</a></span>
                    </div>
                </div>
...
function proses() {
    ...
    if (name === "") {
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>registerinstansi/proses",
            dataType: 'JSON',
            cache: false,
            contentType: false,
            processData: false,
