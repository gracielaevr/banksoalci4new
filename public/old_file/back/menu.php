<div class="collapse navbar-collapse w-auto sidenav-guru" id="sidenav-collapse-main">
    <ul class="navbar-nav">
        <li class="nav-item">
            <a id="dashboard" class="nav-link side-leap side-dashboard" href="<?= base_url() ?>home">
        ...
        <li class="nav-item">
            <a class="nav-link side-leap" href="<?= base_url() ?>admininstansi">
                <i class="fa fa-university text-gray text-sm"></i>
                <span class="nav-link-text ms-1">Admin Instansi</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link side-leap" href="<?= base_url() ?>subscribeadmin">
        ...
        <li class="nav-item">
            <a class="nav-link side-leap" href="<?= base_url() ?>jadwalkonsultasi">
                <i class="fa fa-calendar text-success text-sm"></i>
