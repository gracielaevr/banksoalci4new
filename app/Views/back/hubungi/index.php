                    ...
                    <div class="form-horizontal">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="wa" class="form-control" name="wa" value="<?php echo $wa; ?>" placeholder="08123xxx">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="txt" class="col-sm-2 control-label">Text Chat</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="text" rows="4" id="text"><?php echo $text; ?></textarea>
                                </div>
                            </div>
                        </div>
